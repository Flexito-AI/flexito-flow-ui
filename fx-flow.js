...
/* ====================================================================================
   fx-channels module: WhatsApp Cloud / channel-detail pages (was a separate file, fx-channels.js)
   Self-contained: only affects pages whose .content-card contains a Disconnect (.el-button--danger) button.
   ==================================================================================== */
try{!function(){
